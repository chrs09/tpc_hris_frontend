...
const FinanceTrips = () => {
  ...
  return (
    <div className="space-y-5">
      ...
      {error && (
        <div className="rounded-xl border border-danger/30 bg-danger/15 px-4 py-3 text-danger shadow-sm">
          {error}
        </div>
      )}
      ...
      <div className="grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4">
        <div className="rounded-xl border border-border bg-surface p-5 shadow-sm">
          <p className="text-xs text-fg-subtle">For Finance Review</p>
        ...
        <div className="rounded-xl border border-border bg-surface p-5 shadow-sm">
          <p className="text-xs text-fg-subtle">Approved</p>
        ...
        <div className="rounded-xl border border-border bg-surface p-5 shadow-sm">
          <p className="text-xs text-fg-subtle">Synced to Payroll</p>
