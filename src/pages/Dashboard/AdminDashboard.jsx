    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        <StatCard
          ...
          color="bg-blue-400"
        />
        <StatCard title="Present" value={stats.present} color="bg-green-400" />
        <StatCard title="Absent" value={stats.absent} color="bg-red-400" />
        <StatCard
          title="On Leave"
      ...
      <div className="bg-[#023047] rounded-3xl p-8 shadow-md border border-white/10 mb-10">
        <div className="flex justify-between items-center mb-4">
          ...
          <span className="text-sm text-blue-100">{attendanceRate}% Today</span>
        </div>
        ...
        <p className="mt-4 text-sm text-blue-100">{alertMessage}</p>
      </div>
